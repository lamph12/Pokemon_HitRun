...
public class ConfigBuild
{
    ...
    private static string KeyStorePath = "Assets/01_BirdSort/KeyStore/herowarsort.keystore";
    ...
    [MenuItem("Main Layout/Play &3")]
    public static void ChangeLayoutPlay()
    {
        string path = Path.Combine(Directory.GetCurrentDirectory(), "Assets/Editor/Layouts/Main Code.wlt");
        EditorUtility.LoadWindowLayout(path);
    }
    [MenuItem("Main Layout/Edit &4")]
    public static void ChangeLayoutEdit()
    {
        string path = Path.Combine(Directory.GetCurrentDirectory(), "Assets/Editor/Layouts/Main Edit.wlt");
        EditorUtility.LoadWindowLayout(path);
    }
    ...
    {
        string localPath = "Assets/01_BirdSort/Scenes/HomeScene.unity";
        EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo();
        EditorSceneManager.OpenScene(localPath);
    }
